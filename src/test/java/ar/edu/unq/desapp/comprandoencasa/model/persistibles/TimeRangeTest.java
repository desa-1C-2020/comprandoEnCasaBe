...
public class TimeRangeTest {
    ...
    @Test
    public void whenGivesAnSuggestedHourInsideRange_thenReturnIsInRange() {
        int startTime = 14;
        int endTime = 18;
        TimeRange timeRange = new TimeRange(startTime, endTime);
        int suggestedHour = 17;
        int suggestedminute = 59;

        boolean inRange = timeRange.isInRange(suggestedHour, suggestedminute);

        assertThat(inRange, is(true));
    }

    @Test
    public void whenGivesAnSuggestedHourInLimitOfRange_thenReturnIsInRange() {
        int startTime = 14;
        int endTime = 18;
        TimeRange timeRange = new TimeRange(startTime, endTime);
        int suggestedHour = 18;
        int suggestedminute = 0;
    ...
    @Test
    public void whenGivesAnSuggestedHourOutsideRange_thenReturnIsNotInRange() {
        int startTime = 14;
        int endTime = 18;
        TimeRange timeRange = new TimeRange(startTime, endTime);
        int suggestedHour = 18;
        int suggestedminute = 1;

        boolean inRange = timeRange.isInRange(suggestedHour, suggestedminute);

        assertThat(inRange, is(false));
    }
}